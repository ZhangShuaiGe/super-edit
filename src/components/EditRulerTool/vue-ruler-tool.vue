<template>
    <div v-show="rulerToggle" id="rulerTool"
         :style="{width : config.width + 'px',height : config.height + 'px',position:position}" class="ScaleBox"
...
<script>
    export default {
        ...
        methods: {
            ...
            scaleCalc() {
                for (let i = 0; i < this.config.width; i += 1) {
                    if (i % 50 === 0) {
                        this.xScale.push({id: i})
                    }
                }
                for (let i = 0; i < this.config.height; i += 1) {
                    if (i % 50 === 0) {
                        this.yScale.push({id: i})
                    }
                }
